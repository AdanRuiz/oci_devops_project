...
export function AuthCallbackRoute() {
  ...
  if (auth.error) {
    return (
      <Box
        sx={{ minHeight: '100vh', display: 'grid', placeItems: 'center', px: 3, bgcolor: PAGE_BG }}
      >
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          inset: 0,
          background:
            'radial-gradient(circle at top right, rgba(255,255,255,0.32), transparent 34%), radial-gradient(circle at left center, rgba(255,255,255,0.12), transparent 38%)',
          pointerEvents: 'none',
        }}
      />
